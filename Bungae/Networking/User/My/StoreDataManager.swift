...
class StoreDataManager{
    ...
    func getData(storeIdx: String, completion: @escaping (NetworkResult<Any>) -> Void) {


        let url = APIs.productURL + "/" + storeIdx
...
//            "X-ACCESS-TOKEN" : Keys.KAKAO_JWT
    ...
    private func judge(status : Int, data : Data) -> NetworkResult<Any> {
        ...
        guard let decodedData = try? decoder.decode(StoreData.self, from : data)
        else {
